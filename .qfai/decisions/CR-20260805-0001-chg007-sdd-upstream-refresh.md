...
- Class: `intent`
- Status: `approved`
- Approved by: `user (aganesy) — /qfai-sdd CHG-007 Stage-1 triage, AskUserQuestion approval of the approval-required CREATE (spec-0017), recorded in .qfai/specs/_policies/10_delta.md § CHG-007 triage table (user@2026-08-05); remaining rows were UPDATE-class ops the slice policy does not gate on approval`
...
flags every protected-path diff not named by an approved CR. The SDD wave *is*
